# backend/repositories/item_repository.py
import json
...
class ItemRepository:
    ...
    def get_items_by_restaurant(self, restaurant_id: int) -> List[MenuItem]:
        """Helper to filter menu items by restaurant."""
        all_items = self.load_all()
        return [item for item in all_items if item.restaurant_id == restaurant_id]
